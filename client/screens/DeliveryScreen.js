        ...
        <MapView
            ...
            <View className="rounded-t-3xl -mt-12 bg-white relative">
                <View className="flex-row justify-between px-5 pt-10">
                    <View>
                        <Text className="text-lg text-gray-700 font-semibold">Chegada Estimada</Text>
                        <Text className="text-3xl text-gray-700 font-semibold">20-30 Minutos</Text>
                        <Text className="mt-2 text-gray-700 font-semibold">Seu pedido é próprio, é do seu jeito!</Text>
                    </View>
